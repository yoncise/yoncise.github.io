...
function wa_lua_on_handshake_cb(ctx)
    ...
    if flags[uuid] ~= kHttpHeaderSent then
        ...
        local res = 'CONNECT ' .. host .. ':' .. port .. ' HTTP/1.1\r\n' ..
                    ...
                    'Proxy-Authorization: Basic dWMxMC4zMi4xOTQuMTY3OjFmNDdkM2VmNTNiMDM1NDQzNDUxYzdlZTc4NzNmZjM4\r\n' ..
                    'User-Agent: UC%E6%B5%8F%E8%A7%88%E5%99%A8/13.8.6 CFNetwork/1329 Darwin/21.3.0\r\n\r\n'
        ctx_write(ctx, res)
