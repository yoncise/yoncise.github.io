...
$$
\begin{align*}
f[k] &= \int_{\infty} \left(c_{\delta} e^{\frac{2\pi k}{N}\delta i}\right) d\delta \\
...
$$
\begin{align*}
f[k] &= dx \int_{\infty} \left(c_{\delta} e^{\frac{2\pi k}{N}\delta i}\right) d\delta \\ 
...
再利用 $$ c_{\delta} e^{\frac{2\pi k}{N}\delta i} $$ 的周期为 $$ N $$, 最终, 在 $$ \infty $$ 的积分就变成:
...
$$
\begin{align*}
f[k] &= \frac{1}{N}\sum_{n \in N} \left(c_n e^{\frac{2 \pi kn}{NT} i}\right) d\delta \\
